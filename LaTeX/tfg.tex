...
%Pintado en Sage, añadir gráfica. Remarcar que se aprecia que y- es acotada para v = 1.
			...
			\begin{itemize}
				...
				%Añadir aquí la gráfica amarilla y morada, y referencia despues del "Also"
			\end{itemize}
