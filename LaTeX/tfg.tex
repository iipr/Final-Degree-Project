...
\tikzstyle{estiloborde4} = [line width=2pt, draw=green!70, rounded corners=8pt]
...
\draw[estiloborde5,decorate,decoration={
    markings,
    mark=at position 0.5 with {\arrow[blue!80,opacity=0.6]{>}}}](-2.839,-.514)--(-2.839,-1.316)--(-.081,-.779);
\draw[estiloborde,draw=blue!70](-2.839,-.514)--(-2.839,-1.316)--(-.081,-.779);
%Estoy aquí: -------> beta_1
\draw[estiloborde3, opacity=1](-3.9,-.789)--(-3.893,-1.521)--(-3.731,-2.253)--(-3.244,-2.921)--(-2.433,-2.763)--(-1.622,-3.368)--(-.811,-3.211)--(0,-3.053)--(0,-1.526)--(0,-.763)--(0,.038)--(0,.763)--(0,1.526)--(-.811,2.132)--(-2.433,1.816)--(-3.244,2.421)--(-4.056,1.5)--(-4.056,.737)--cycle;
...
%Y aquí con el rojo: beta_1
\draw[estiloborde3,opacity=0.9](-3.9,-.789)--(-3.893,-1.521)--(-3.731,-2.253)--(-3.244,-2.921)--(-2.433,-2.763)--(-1.622,-3.368)--(-.811,-3.211)--(0,-3.053)--(0,-1.526)(0,.038)--(0,.763)--(0,1.526)--(-.811,2.132)--(-2.433,1.816)--(-3.244,2.421)--(-4.056,1.5)--(-4.056,.737);
\draw[estiloborde3,decorate,decoration={
    markings,
    mark=at position 0.5 with {\arrow[red!80,opacity=0.6]{>}}}]
(-4.056,1.)--(-4.056,-0.5);
\draw[estiloborde3,decorate,decoration={
    markings,
    mark=at position 0.5 with {\arrow[red!80,opacity=0.6]{>}}}]
...
\draw[estiloborde5,decorate,decoration={
    markings,
    mark=at position 0.5 with {\arrow[blue!80,opacity=0.6]{>}}}](-.081,.747)--(-2.839,.211)--(-2.839,-.514);
...
\path (0,0.65) node[right]{$y_1$};
\path [black!20!green] (-0.7,-0.1) node[right]{$\beta_0$};
\path (2.5,1.468) node[above right]{${\mathbb D}_A(\eps)$};
\path [red] (-4.3,-1.5) node[below]{$\beta_1$};
\path [blue] (-1.1,.526) node[below]{$\gamma$};
\end{tikzpicture}
\caption{The path $\beta$ meets transversally once the disk ${\mathbb D}_A$. Here $y_0:=\beta(-\eps)$ and $y_1:=\beta(\eps)$.}\label{pic:disco}
\end{center}
\end{figure}
