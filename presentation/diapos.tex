...
\institute{
	\vspace{-0.3cm} \\
	\protect\includegraphics[scale=0.75]{ucm.eps}\\
	\vspace{0.2cm}
...
\begin{frame}
\frametitle{The problem and its origin}
...
\begin{figure}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (img)at (0,0) {\includegraphics[width=0.837\textwidth]{plots/ch2_07_A.pdf}};
...
$\star$ $f_2=h\circ g$, where $g:\overline{\Qu}\to\R^3,\ h:\R^3\to\R^2$ and:% \vspace{-0.2cm}
\begin{align*}
g(\x,\y)&:=\big(\x\y^2+\x^2\y-\y-1,\,\x^{3/2}\y,\,\x^3\y+\x\y-\x-1\big),\\
h(\x,\y,\z)&:=\big(\x^2+\y^2,\,\y^2+\z^2\big).
...
\begin{center}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (img)at (0,0) {\includegraphics[height=4cm]{plots/ch3_02_B2.png}};
\path ($(img.north west)!0.25!(img.north east)$)|-coordinate(c1)($(img.south east)!0.55!(img.north east)$);
\path ($(img.north west)!0.6!(img.north east)$)|-coordinate(c2)($(img.south east)!0.45!(img.north east)$);
\draw (c1) node {{$\D_1$}};
\draw (c2) node {{$\phi_M(\Rr_M)$}};
\end{tikzpicture}
\end{center}
\vspace{-0.6cm}
\begin{center}
$\partial\D_1$ meets the boundary map $\partial\tilde{\phi}_M:\partial\tilde{\overline{\Rr}}_M\rightarrow\R^3$, where $\phi_M(\Rr_M) \subset g(\overline{\Qu})$.
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
\begin{center}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (img)at (0,0) {\includegraphics[height=4cm]{plots/ch3_01_A2.png}};
\path ($(img.north west)!0.47!(img.north east)$)|-coordinate(c1)($(img.south east)!0.25!(img.north east)$);
\path ($(img.north west)!0.45!(img.north east)$)|-coordinate(c2)($(img.south east)!0.5!(img.north east)$);
\draw (c1) node {{$\D_2$}};
\draw (c2) node {{$\phi_M(\Rr_M)$}};
\end{tikzpicture}
\end{center}
...
$\star$ \textbf{Optimal algebraic structure:}
\vspace{0.1cm}

$\ \ \cdot$ Total degree.

$\ \ \cdot$ Total number of monomials (sparseness).
\vspace{0.3cm} 

$\star$ \textbf{Optimal multiplicative complexity:} 
\vspace{0.1cm}

$\ \ \cdot$ Minimum number of non-scalar products.
\vspace{0.3cm}
...
$\FFF = f_2 \circ f_1$ & 28 & 22 & 11\\ \hline \hline
...
\vspace{-0.3cm}
\begin{center}
%\animategraphics[loop,totalheight=8cm]{12}{prueba-}{0}{99}
\begin{animateinline}[autoplay,totalheight=8cm,loop]{12}
	\multiframe{21}{i=0+1}{
	\includegraphics{gifs/yes-\i.png}
	}
	\newframe*
	\multiframe{51}{i=20+1}{
	\includegraphics{gifs/yes-\i.png}
	}
\end{animateinline}
\end{center}
...
\begin{animateinline}[autoplay,totalheight=8cm,loop]{12}
	\multiframe{20}{i=1+1}{
	\includegraphics{gifs/gammas-\i.png}
	}
	\newframe*
	\multiframe{69}{i=20+1}{
	\includegraphics{gifs/gammas-\i.png}
	}
\end{animateinline}
\end{center}
...
\begin{figure}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (img)at (0,0) {\includegraphics[width=0.4\textwidth]{plots/ch2_07_A.pdf}};
\path ($(img.north west)!0.6!(img.north east)$)|-coordinate(c1)($(img.south east)!0.7!(img.north east)$);% c1: lugar donde poner \mathscr{A}
\draw (c1) node {\large{$\mathscr{A}$}};
\end{tikzpicture}
\end{figure}
...
%\begin{comment}
\begin{frame}
\frametitle{The family of curves for the $g$: $\alpha_\lambda(s)$ and $\beta_\mu(s)$}
\vspace{-0.3cm}
\begin{center}
\begin{animateinline}[autoplay,totalheight=8cm,loop]{12}
	\multiframe{40}{i=0+1}{
	\includegraphics{gifs/alpbet-\i.png}
	}
\end{animateinline}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{The family of curves for the $f_2$: $\gamma_\lambda(s)$ and $\delta_\mu(s)$}
\vspace{-0.3cm}
\begin{center}
\begin{animateinline}[autoplay,totalheight=8cm,loop]{12}
	\multiframe{34}{i=0+1}{
	\includegraphics{gifs/gamdel-\i.png}
	}
\end{animateinline}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{The family of curves for the $\mathcal{N}_1$ and $\mathcal{N}_2$: $\sigma_\lambda(s)$ and $\tau_\mu(s)$}
\vspace{-0.3cm}
\begin{center}
\begin{animateinline}[autoplay,totalheight=8cm,loop]{12}
	\multiframe{80 }{i=0+1}{
	\includegraphics{gifs/sigtau-\i.png}
	}
\end{animateinline}
\end{center}
\end{frame}
